-- NOTE: No data inside database. Could not find dataset provided by Coursera. All statements should be valid.
...
-- NOTE: Unsure why ANY operator is required.
...
-- NOTE: Task instructions did not specify adding CustomerID for the booking, this has been included when creating the procedure by author's discretion.
