...
CREATE TABLE `Orders` (
  ...
  KEY `statusID_fk_idx` (`OrderStatusID`),
  ...
  CONSTRAINT `orderStatusID_fk` FOREIGN KEY (`OrderStatusID`) REFERENCES `OrderStatus` (`OrderStatusID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-06-22  0:03:21
